...
def main():
    ...
    # use wandb
    watermark = "re_{}_{}_{}_warm_{}_on_{}_{}_window_{}".format(args.selection, args.fraction, args.select_every, args.warm_epoch, args.dataset, args.model, args.window_ratio, args.lr, args.epochs)
    wandb.init(project="re-tl-derma", name=watermark)
